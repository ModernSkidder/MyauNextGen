...
public class TargetHUD extends Module {
    ...
    public final ModeValue style = new ModeValue("Style", 0, new String[]{"Myau", "Adjust"});
    ...
    public final IntValue offY = new IntValue("offset-y", 40, -500, 500);
    ...
    public final BooleanValue trackTarget = new BooleanValue("track-target", false);
    public final ModeValue trackingMode = new ModeValue("tracking-mode", 0, new String[]{"TOP", "MIDDLE", "LEFT", "RIGHT"}, trackTarget::getValue);
    public final BooleanValue distanceScale = new BooleanValue("distance-scale", true, trackTarget::getValue);
