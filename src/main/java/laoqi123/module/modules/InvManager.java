...
public class InvManager extends Module {
    ...
    public final IntProperty pearlSlot = new IntProperty("pearl-slot", 6, 0, 9);
    public final IntProperty fireChargeSlot = new IntProperty("fire-charge-slot", 7, 0, 9);
    public final IntProperty fireCharges = new IntProperty("fire-charges", 64, 0, 2304);
    public final IntProperty windCharges = new IntProperty("wind-charges", 64, 0, 2304);
    public final IntProperty mace = new IntProperty("mace", 1, 0, 4);
    ...
    public final BooleanProperty autoOffhand = new BooleanProperty("auto-offhand", false);
