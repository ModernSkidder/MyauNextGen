...
public class BlockHit extends Module {
    ...
    public final ModeValue mode = new ModeValue("Mode", 0, new String[]{"Helper", "Auto", "Lag"});

    public final IntValue stopTime = new IntValue("Stop Ticks", 2, 1, 5, () -> this.mode.getValue() == 0);
    public final ModeValue autoMode = new ModeValue("Auto Mode", 0, new String[]{"Spam", "Hold"}, () -> this.mode.getValue() == 1 && this.autoBlockTime.getValue() == 0);
    public final ModeValue autoBlockTime = new ModeValue("AutoBlock Time", 0, new String[]{"Delay", "HurtTime", "Sag", "Smart"}, () -> this.mode.getValue() == 1);
    public final IntValue smartBlockTick = new IntValue("Smart Block Ticks", 2, 1, 5, () -> this.mode.getValue() == 1 && this.autoBlockTime.getValue() == 3);
    public final IntValue blockDelay = new IntValue("Block Delay", 100, 0, 1000, () -> this.mode.getValue() == 1 && this.autoBlockTime.getValue() == 0);
    public final IntValue holdTick = new IntValue("Hold Ticks", 2, 2, 5, () -> this.mode.getValue() == 1 && this.autoMode.getValue() == 1 && this.autoBlockTime.getValue() == 0);
    public final IntValue minHurtTime = new IntValue("Min HurtTime", 10, 1, 10, () -> this.mode.getValue() == 1 && this.autoBlockTime.getValue() == 1);
    public final IntValue maxHurtTime = new IntValue("Max HurtTime", 10, 1, 10, () -> this.mode.getValue() == 1 && this.autoBlockTime.getValue() == 1);
    public final IntValue delayPacketTick = new IntValue("Delay Packet Ticks", 2, 1, 10, () -> this.mode.getValue() == 2);
    public final IntValue blockTick = new IntValue("Block Ticks", 3, 1, 5, () -> this.mode.getValue() == 2);
    public final IntValue startHurtTime = new IntValue("Start HurtTime", 6, 1, 10, () -> this.mode.getValue() == 2);
    public final PercentValue chance = new PercentValue("Block Hit Chance", 50, () -> this.mode.getValue() == 1);
    public final BooleanValue smart = new BooleanValue("Smart", true, () -> this.mode.getValue() == 1);
    public final BooleanValue autoBlockRange = new BooleanValue("AutoBlock Range", true, () -> this.mode.getValue() == 1);
    public final FloatValue range = new FloatValue("Range", 3.0f, 1f, 4f, () -> autoBlockRange.getValue() && mode.getValue() == 1);
