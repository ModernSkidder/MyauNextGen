...
public class OutlineShader extends Shader {
    ...
    public void onUse() {
        ...
        float invW = 1.0f / MinecraftClient.getInstance().getWindow().getFramebufferWidth();
        float invH = 1.0f / MinecraftClient.getInstance().getWindow().getFramebufferHeight();
