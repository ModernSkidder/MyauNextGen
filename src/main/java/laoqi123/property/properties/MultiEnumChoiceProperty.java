...
public class MultiEnumChoiceProperty<E extends Enum<E> & NamedChoice> extends Property<EnumSet<E>> {

    private final E[] values;

    public MultiEnumChoiceProperty(String name, E[] values, BooleanSupplier check) {
